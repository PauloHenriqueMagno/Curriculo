    ...
    <body>
        <header class="main_header">
            ...
            <div class="header_background_image">
                <img src="../image/user.png" alt="Usuario" class="header_user">
                <button class="header_user_camera mobile_hidden">
                <img src="../image/camera.png" alt="Mudar imagem de usuario">
                </button>
                <button class="header_background_button"><img src="../image/camera.png"><span class="mobile_hidden">Editar foto de capa</span></button>
            </div>
        ...
        <main class="main_main">
                    ...
                    <nav class="main_stick-menu">
                        ...
                        <ul class="main_stick_menu_left">
                            ...
                            <li class="mobile_hidden">
                                ...
                                <div class="friends">
                                    <p>Você não tem amigos <img src="../image/sadface.png" alt="sad face"></p>
                                </div>
                            </li>
                            <li class="mobile_hidden">
                        ...
                        <ul class="main_stick_menu_right">
                            <li><button><img src="../image/mais.png">Adicionar ao story</button></li>
                            <li><button id="button_change_profile_info"><img src="../image/lapis.png">Editar nome</button></li>
                            <li><button>...</button></li>
                        </ul>
            ...
            <aside class="main_content_aside flex">
                ...
                <section class="presentation flex main_aside">
                    <h2>Apresentação</h2>
                    <ul>
                        <li><img src="../image/house.png"><p>Mora em <strong>São Paulo</strong></p></li>
                        <li><img src="../image/gps.png"><p>De <strong>São Paulo</strong></p></li>
                        <li><img src="../image/heart.png"><p>Em um relacionamento sério com <strong>Programação</strong></p></li>
                    </ul>
                ...
                <section class="main_content_aside_section main_aside">
                    ...
                    <figure class="aside_figure">
                        <img src="../image/duck.jpg" alt="foto de pato de borracha">
            ...
            <div class="main_content" id="publications">
                <section class="main_content_post_send">
                    <div class="main_content_post_send_input flex">
                        <img src="../image/user.png" alt="Usuário">
                        <button id="button_post_content">No que você está pensando?</button>
                    </div>
                    <div class="main_content_post_send_buttons flex">
                        <button>
                            <img src="../image/video_camera_red.png" alt="camera">
                            Video ao vivo
                        </button>
                        <button>
                            <img src="../image/photos.png" alt="fotos">
                            Foto/video
                        </button>
                        <button>
                            <img src="../image/flag_blue.png" alt="bandeira">
                            Acontecimento
                        </button>
                    </div>
                </section>
